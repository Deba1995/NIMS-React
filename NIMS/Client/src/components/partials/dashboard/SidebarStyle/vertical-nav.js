  ...
  return (
    <Fragment>
      <Accordion as="ul" className="navbar-nav iq-main-menu">
          ...
          <Accordion.Collapse eventKey="sidebar-user">
            <ul className="sub-nav">
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/user/user-add-department"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/dashboard/user/user-add-department"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="item-name">Add Department</span>
                </Link>
              </li>
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/user/user-add-designation"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/dashboard/user/user-add-designation"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <i className="sidenav-mini-icon"> U </i>
                  <span className="item-name">Add Designation</span>
                </Link>
              </li>
              ...
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/user/user-add-user"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/dashboard/user/user-add-user"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <Accordion.Item
          as="li"
          eventKey="sidebar-client"
          bsPrefix={`nav-item ${active === "client" ? "active" : ""} `}
        ...
        >
          ...
          <Accordion.Collapse eventKey="sidebar-client">
            <ul className="sub-nav">
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/client/client-add-sector"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/dashboard/client/client-add-sector"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/client/client-add-client"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/dashboard/client/client-add-client"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <i className="sidenav-mini-icon"> U </i>
                  <span className="item-name">Add Client</span>
                </Link>
              </li>
            </ul>
          </Accordion.Collapse>
        ...
        <Accordion.Item
          as="li"
          eventKey="sidebar-client"
          bsPrefix={`nav-item ${active === "oem" ? "active" : ""} `}
          onClick={() => setActive("oem")}
        >
          <CustomToggle
            eventKey="sidebar-oem"
            onClick={(activeKey) => setActiveMenu(activeKey)}
          >
            <i className="icon">
              <svg
            ...
            <span className="item-name">Oems</span>
            <i className="right-icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
          ...
          <Accordion.Collapse eventKey="sidebar-oem">
            <ul className="sub-nav">
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/oem/oem-add-oem"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/dashboard/oem/oem-add-oem"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <i className="sidenav-mini-icon"> U </i>
                  <span className="item-name">Add Oem</span>
                </Link>
              </li>
              ...
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/oem/oem-add-product"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/dashboard/oem/oem-add-product"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <Accordion.Collapse eventKey="utilities-error">
            <ul className="sub-nav">
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/oem/oem-add-order"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/dashboard/oem/oem-add-order"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="item-name">Create Order</span>
                </Link>
              </li>
            </ul>
          </Accordion.Collapse>
        ...
        <Accordion.Item
          as="li"
          eventKey="admin-error"
          bsPrefix={`nav-item ${active === "error" ? "active" : ""} `}
          onClick={() => setActive("error")}
        >
          <CustomToggle
            eventKey="admin-error"
            active={activeMenu === "admin-error" ? true : false}
            onClick={(activeKey) => setActiveMenu(activeKey)}
          >
            <i className="icon">
              <svg
          ...
          <Accordion.Collapse eventKey="admin-error">
            <ul className="sub-nav">
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/admin/adminprofile"
                      ? "active"
                      : ""
                  } nav-link`}
